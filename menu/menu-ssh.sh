...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "\033[42m          JOEXMASTER AUTOSCRIPT          \033[0m"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    echo -e ""
...
echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
echo -e "\033[1;93m┌──────────────────────────────────────────┐\033[0m"
echo -e "  ${ORANGE}[1].${NC}\033[0;36m Create SSH & OVPN${NC}"
echo -e "  ${ORANGE}[2].${NC}\033[0;36m Trial SSH & OVPN${NC}"
echo -e "  ${ORANGE}[3].${NC}\033[0;36m Renew SSH & OVPN${NC}"
echo -e "  ${ORANGE}[4].${NC}\033[0;36m Check User Login SSH & OVPN${NC}"
echo -e "  ${ORANGE}[5].${NC}\033[0;36m Daftar Member SSH & OVPN ${NC}"
echo -e "  ${ORANGE}[6].${NC}\033[0;36m Hapus SSH & OVPN ${NC}"
echo -e "  ${ORANGE}[7].${NC}\033[0;36m Hapus User Expired SSH & OVPN ${NC}"
