...
# Author  : JOEXMASTER
# (C) Copyright 2021-2022 By JOEXMASTER
# =========================================
...
echo -e "           OWNER : ${GREEN} BTR ${NC}${YELLOW}(${NC} ${GREEN} JOEXMASTER  ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By JOEXMASTER ${YELLOW}(${NC} FUCKING PARADISE ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
